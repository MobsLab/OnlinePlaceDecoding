...
for polytrode=1:n_polytrode
	...
	if n_events~=0
		...
		[Rate_function_matrix, Marginal_rate_function_matrix, Occupation_matrix] = ...
            bayesian_encoding(DATA(polytrode).events(:,n_events_start:n_events_learning),...
            DATA(polytrode).cleaned_positions(:,1:end/2), N_bins, Bandwidths,T);
