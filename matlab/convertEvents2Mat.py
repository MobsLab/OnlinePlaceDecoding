...
import h5py  # Added for HDF5 support. Updated on 2024/12/10 by AG
import argparse
...
'''
    # Save using HDF5 to handle large datasets, Updated on 2024/12/10 by AG
    ...
    with h5py.File(output_file, 'w') as f:
        ...
        # Add a MATLAB-readable format identifier
        f.attrs['MATLAB_class'] = "HDF5"
